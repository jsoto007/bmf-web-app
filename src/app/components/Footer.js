...
export default function Footer() {
  ...
  return (
    <div id="footer" className="relative isolate overflow-hidden bg-neutral-100 py-24 sm:py-32" >
      <div
        ...
        <hr className="font-bold sm:mt-2 md:mt-10 lg:mt-20"/>
          <div className="text-slate-700 items-center sm:mt-5 md:mt-8 lg:mt-12 text-sm">
              <ul className="text-slate-700">
                <li>
                  Copyright © {year} - All Rights Reserved.<span className="ml-3 text-xs">Powered by JSoto</span>
                </li>
              </ul>
          </div>
      </div>
